...
class MyFrame(wx.Frame, GuiCreator):
    ...
    def OnSelectFont(self, event):
        font = wx.GetFontFromUser(self, wx.Font(12, wx.FONTFAMILY_TELETYPE, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL), caption="Select a Font")
        if wx.Font.IsOk(font):
            self.SetTitle("Font selected: %s" % font.GetNativeFontInfoUserDesc())
        else:
            self.SetTitle("No font selected")
