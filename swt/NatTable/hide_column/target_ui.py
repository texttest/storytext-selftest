...
from org.eclipse.nebula.widgets.nattable.resize.command import InitializeAutoResizeColumnsCommand, InitializeAutoResizeRowsCommand,ColumnResizeCommand
...
def createNatTable(parent):
    ...
    table.doCommand(ColumnResizeCommand(rowHeaderLayer, 0, 0))
    return table
...
class MyPaintListener(Listener):
    ...
    def handleEvent(self, e):
        ...
        self.resized = True
        table = e.widget
        for i in range(1, table.getColumnCount()):
