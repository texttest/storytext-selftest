...
middleComposite = Composite(composite, SWT.NONE)
layout = GridLayout(1, False)
middleComposite.setLayout(layout)

label2Composite = Composite(middleComposite, SWT.NONE)
layout = GridLayout(2, False)
label2Composite.setLayout(layout)

label2 = Label(label2Composite, SWT.NONE)
label2.setText("Home")
